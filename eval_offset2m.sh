...
# --output_root out --project emernerf_carla --run_name debug_lidar_Town01_cam1_offset2m \
# --eval_only \
...
# --output_root out --project emernerf_carla --run_name debug_lidar_Town02_cam1_offset2m \
# --eval_only \
...
# CUDA_VISIBLE_DEVICES=5 python train_emernerf.py --config_file configs/default_dynamic.yaml \
# --output_root out --project emernerf_carla --run_name debug_lidar_Town03_cam1_offset2m \
# --eval_only \
...
# --output_root out --project emernerf_carla --run_name debug_lidar_Town05_cam1_offset2m \
# --eval_only \
...
# CUDA_VISIBLE_DEVICES=1 python train_emernerf.py --config_file configs/default_dynamic.yaml \
# --output_root out --project emernerf_carla --run_name debug_lidar_Town10_cam1_offset2m \
# --eval_only \
...
--output_root out --project emernerf_carla --run_name debug_lidar_Town01_cam3_offset2m \
--eval_only \
...
CUDA_VISIBLE_DEVICES=1 python train_emernerf.py --config_file configs/default_dynamic.yaml \
--output_root out --project emernerf_carla --run_name debug_lidar_Town02_cam3_offset2m \
--eval_only \
...
--output_root out --project emernerf_carla --run_name debug_lidar_Town03_cam3_offset2m \
--eval_only \
...
--output_root out --project emernerf_carla --run_name debug_lidar_Town05_cam3_offset2m \
--eval_only \
...
CUDA_VISIBLE_DEVICES=5 python train_emernerf.py --config_file configs/default_dynamic.yaml \
--output_root out --project emernerf_carla --run_name debug_lidar_Town10_cam3_offset2m \
--eval_only \
